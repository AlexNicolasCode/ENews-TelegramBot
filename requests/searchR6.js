...
request("https://news.google.com/search?q=rainbow%20six&hl=pt-BR&gl=BR&ceid=BR%3Apt-419", function(err, res, body) {
...
//      console.log(loadLinks);
      ...
      loadLinks.forEach(function(item){
          ...
          linkUrl.push(url + "\n");
          fs.writeFileSync("./requests/links/linksR6.txt", linkUrl, (err) => {
              if (err)
                console.log(err);
          });
        });
